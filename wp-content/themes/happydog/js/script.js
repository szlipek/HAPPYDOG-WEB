...
if (document.querySelector('.product__gallery-row')) {
    const productSlider = tns({
        ...
        onInit: function(e){
            const imgUrl = document.querySelector('.tns-slide-active a').getAttribute('href');
            document.querySelector('.product__image img').setAttribute('src', imgUrl);
